...
public class Client implements Runnable {
    ...
    GestioneParcheggioRemote gp;
    int id;

    public Client(GestioneParcheggioRemote gp, int id) {
        this.id = id;
        this.gp = gp;
    }
    ...
    public void run() {
        try {
            ...
            while (!parcheggiato) {
                ...
                } catch (GestioneParcheggioRemote.PianoInesistente e) {
                    piano_corrente = 0;
                    parcheggiato = false;
                } catch (GestioneParcheggioRemote.NoStalliLiberi e) {
                    parcheggiato = false;
                }
            }
